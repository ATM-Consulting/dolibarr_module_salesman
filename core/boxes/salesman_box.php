 ...
 */
class salesmanbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "salesman@salesman";
    public $boxlabel;
    public $depends = array("salesman");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/salesman/class/salesman.class.php";
